        ...
        <div className="container mx-auto flex items-center p-4">
          <Link to="/" className="flex items-center" onClick={closeNavbar}>
            <img
              ...
              className="mr-2"
            />
            <span className="text-lg font-semibold text-black-300 pr-4">
              Little Ram Pantries
            </span>
          </Link>
          ...
          <div
            className={`lg:flex lg:items-center lg:static absolute top-full left-0 w-full lg:w-auto ${isOpen ? 'bg-white block' : 'hidden'}`}
          >
            <div className="flex flex-col lg:flex-row lg:ml-auto">
              <Link
                to="/"
                className="py-2 px-4 hover:bg-gray-200 text-gray-500"
                onClick={closeNavbar}
              >
                Home
              </Link>
