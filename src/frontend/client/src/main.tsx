...
const sites: SchoolConfig[] = [
  {
    ...
    blurb_1:
      'With 14 accessible locations across both VCU campuses, free food is never far away.',
    blurb_2:
      'We pride ourselves on keeping our pantries restocked weekly, ensuring you have fresh options whenever you need them.',
  },
];
